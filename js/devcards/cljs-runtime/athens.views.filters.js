...
var num_filters = cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__61506){
var vec__61507 = p__61506;
var _k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61507,(0),null);
...
})], null),"Reset"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.views.filters.filter_list_style),(((cljs.core.count(items__$2) > (0)))?cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4582__auto__ = (function athens$views$filters$filters_el_$_iter__61510(s__61511){
return (new cljs.core.LazySeq(null,(function (){
var s__61511__$1 = s__61511;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__61511__$1);
if(temp__5735__auto__){
var s__61511__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__61511__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__61511__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__61513 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__61512 = (0);
while(true){
if((i__61512 < size__4581__auto__)){
var vec__61514 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__61512);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61514,(0),null);
var map__61517 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61514,(1),null);
...
var count = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61517__$1,new cljs.core.Keyword(null,"count","count",2139924085));
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61517__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
...
cljs.core.chunk_append(b__61513,cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([athens.views.filters.filter_style,((added_QMARK_)?athens.views.filters.added_style:((excluded_QMARK_)?athens.views.filters.excluded_style:null))], 0)),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__61512,added_QMARK_,excluded_QMARK_,vec__61514,k,map__61517,map__61517__$1,count,state,c__4580__auto__,size__4581__auto__,b__61513,s__61511__$2,temp__5735__auto__,sort_,filtered_items,items__$2,num_filters,s){
return (function (_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(s,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"items","items",1031954938),k,new cljs.core.Keyword(null,"state","state",-1988618099)], null),(function (){var G__61519 = state;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__61519)){
return new cljs.core.Keyword(null,"added","added",2057651688);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"added","added",2057651688),G__61519)){
return new cljs.core.Keyword(null,"excluded","excluded",-715952088);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"excluded","excluded",-715952088),G__61519)){
return null;
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__61519)].join('')));

}
}
}
})());
});})(i__61512,added_QMARK_,excluded_QMARK_,vec__61514,k,map__61517,map__61517__$1,count,state,c__4580__auto__,size__4581__auto__,b__61513,s__61511__$2,temp__5735__auto__,sort_,filtered_items,items__$2,num_filters,s))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__61513),athens$views$filters$filters_el_$_iter__61510(cljs.core.chunk_rest(s__61511__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__61513),null);
}
} else {
var vec__61520 = cljs.core.first(s__61511__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61520,(0),null);
var map__61523 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61520,(1),null);
var map__61523__$1 = (((((!((map__61523 == null))))?(((((map__61523.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__61523.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__61523):map__61523);
var count = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61523__$1,new cljs.core.Keyword(null,"count","count",2139924085));
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61523__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var added_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(state,new cljs.core.Keyword(null,"added","added",2057651688));
var excluded_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(state,new cljs.core.Keyword(null,"excluded","excluded",-715952088));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([athens.views.filters.filter_style,((added_QMARK_)?athens.views.filters.added_style:((excluded_QMARK_)?athens.views.filters.excluded_style:null))], 0)),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (added_QMARK_,excluded_QMARK_,vec__61520,k,map__61523,map__61523__$1,count,state,s__61511__$2,temp__5735__auto__,sort_,filtered_items,items__$2,num_filters,s){
return (function (_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(s,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"items","items",1031954938),k,new cljs.core.Keyword(null,"state","state",-1988618099)], null),(function (){var G__61525 = state;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__61525)){
return new cljs.core.Keyword(null,"added","added",2057651688);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"added","added",2057651688),G__61525)){
return new cljs.core.Keyword(null,"excluded","excluded",-715952088);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"excluded","excluded",-715952088),G__61525)){
return null;
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__61525)].join('')));

}
}
}
})());
});})(added_QMARK_,excluded_QMARK_,vec__61520,k,map__61523,map__61523__$1,count,state,s__61511__$2,temp__5735__auto__,sort_,filtered_items,items__$2,num_filters,s))
], null)),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.views.filters.count_style),count], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.views.filters.filter_name_style),k], null),((((added_QMARK_) || (excluded_QMARK_)))?new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.views.filters.state_style),state,((added_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$material_ui$icons$index.Check], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$material_ui$icons$index.Block], null))], null):null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),k], null)),athens$views$filters$filters_el_$_iter__61510(cljs.core.rest(s__61511__$2)));
}
} else {
return null;
}
