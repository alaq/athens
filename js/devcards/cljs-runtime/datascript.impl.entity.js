...
var G__32634 = db;
var G__32635 = e;
var G__32636 = cljs.core.volatile_BANG_(false);
var G__32637 = cljs.core.volatile_BANG_(cljs.core.PersistentArrayMap.EMPTY);
return (datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4 ? datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4(G__32634,G__32635,G__32636,G__32637) : datascript.impl.entity.__GT_Entity.call(null,G__32634,G__32635,G__32636,G__32637));
} else {
return null;
}
});
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__32638_SHARP_,p2__32639_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__32638_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__32639_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
} else {
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__32640_SHARP_,p2__32641_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__32640_SHARP_,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__32641_SHARP_));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
if(datascript.db.ref_QMARK_(db,a)){
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__32642_SHARP_,p2__32643_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__32642_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"e","e",1381269198).cljs$core$IFn$_invoke$arity$1(p2__32643_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
return not_found;
...
var iter__4582__auto__ = (function datascript$impl$entity$js_seq_$_iter__32644(s__32645){
return (new cljs.core.LazySeq(null,(function (){
var s__32645__$1 = s__32645;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__32645__$1);
if(temp__5735__auto__){
var s__32645__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__32645__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__32645__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__32647 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__32646 = (0);
while(true){
if((i__32646 < size__4581__auto__)){
var vec__32648 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__32646);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32648,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32648,(1),null);
cljs.core.chunk_append(b__32647,((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)));

var G__32738 = (i__32646 + (1));
i__32646 = G__32738;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__32647),datascript$impl$entity$js_seq_$_iter__32644(cljs.core.chunk_rest(s__32645__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__32647),null);
}
} else {
var vec__32651 = cljs.core.first(s__32645__$2);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32651,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32651,(1),null);
return cljs.core.cons(((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)),datascript$impl$entity$js_seq_$_iter__32644(cljs.core.rest(s__32645__$2)));
}
} else {
return null;
}
...
var G__32778 = seq__32655;
var G__32779 = chunk__32656;
var G__32780 = count__32657;
var G__32781 = (i__32658 + (1));
seq__32655 = G__32778;
chunk__32656 = G__32779;
count__32657 = G__32780;
i__32658 = G__32781;
continue;
} else {
...
var G__32782 = cljs.core.chunk_rest(seq__32655__$1);
var G__32783 = c__4609__auto__;
var G__32784 = cljs.core.count(c__4609__auto__);
var G__32785 = (0);
seq__32655 = G__32782;
chunk__32656 = G__32783;
count__32657 = G__32784;
i__32658 = G__32785;
continue;
} else {
...
var G__32788 = cljs.core.next(seq__32655__$1);
var G__32789 = null;
var G__32790 = (0);
var G__32791 = (0);
seq__32655 = G__32788;
chunk__32656 = G__32789;
count__32657 = G__32790;
i__32658 = G__32791;
continue;
}
} else {
...
var G__32758__2 = (function (f,use_as_this){
var self__ = this;
var this$ = this;
var seq__32673 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__32674 = null;
var count__32675 = (0);
var i__32676 = (0);
while(true){
if((i__32676 < count__32675)){
var vec__32694 = chunk__32674.cljs$core$IIndexed$_nth$arity$2(null,i__32676);
...
var G__32803 = seq__32673;
var G__32804 = chunk__32674;
var G__32805 = count__32675;
var G__32806 = (i__32676 + (1));
seq__32673 = G__32803;
chunk__32674 = G__32804;
count__32675 = G__32805;
i__32676 = G__32806;
continue;
} else {
...
var c__4609__auto__ = cljs.core.chunk_first(seq__32673__$1);
var G__32807 = cljs.core.chunk_rest(seq__32673__$1);
var G__32808 = c__4609__auto__;
var G__32809 = cljs.core.count(c__4609__auto__);
var G__32810 = (0);
seq__32673 = G__32807;
chunk__32674 = G__32808;
count__32675 = G__32809;
i__32676 = G__32810;
continue;
} else {
var vec__32697 = cljs.core.first(seq__32673__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32697,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32697,(1),null);
f.call(use_as_this,v,a,this$);


var G__32816 = cljs.core.next(seq__32673__$1);
var G__32817 = null;
var G__32818 = (0);
var G__32819 = (0);
seq__32673 = G__32816;
chunk__32674 = G__32817;
count__32675 = G__32818;
i__32676 = G__32819;
continue;
}
} else {
...
G__32758 = function(f,use_as_this){
switch(arguments.length){
case 1:
return G__32758__1.call(this,f);
case 2:
return G__32758__2.call(this,f,use_as_this);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__32758.cljs$core$IFn$_invoke$arity$1 = G__32758__1;
G__32758.cljs$core$IFn$_invoke$arity$2 = G__32758__2;
return G__32758;
})()
);
...
var G__32700 = (datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2 ? datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2(this$,attr) : datascript.impl.entity.lookup_entity.call(null,this$,attr));
if(datascript.db.multival_QMARK_(self__.db,attr)){
return datascript.impl.entity.multival__GT_js(G__32700);
} else {
return G__32700;
}
}
...
var self__ = this;
var this$__$1 = this;
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("datascript.impl.entity","nf","datascript.impl.entity/nf",-953741353),(function (){var G__32701 = this$__$1;
var G__32702 = k;
var G__32703 = new cljs.core.Keyword("datascript.impl.entity","nf","datascript.impl.entity/nf",-953741353);
return (datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$3 ? datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$3(G__32701,G__32702,G__32703) : datascript.impl.entity.lookup_entity.call(null,G__32701,G__32702,G__32703));
})());
}));
...
var self__ = this;
var self__ = this;
var G__32704 = (arguments.length - (1));
switch (G__32704) {
case (1):
...
var temp__5735__auto___32886 = cljs.core.not_empty(datascript.db._search(e.db,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [e.eid], null)));
if(cljs.core.truth_(temp__5735__auto___32886)){
var datoms_32889 = temp__5735__auto___32886;
cljs.core.vreset_BANG_(e.cache,datascript.impl.entity.touch_components(e.db,datascript.impl.entity.datoms__GT_cache(e.db,datoms_32889)));
