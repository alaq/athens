...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner61673 !== 'undefined')){
} else {
...
*/
athens.devcards.spinner.t_athens$devcards$spinner61673 = (function (meta61674){
this.meta61674 = meta61674;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner61673.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61675,meta61674__$1){
var self__ = this;
var _61675__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner61673(meta61674__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner61673.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61675){
var self__ = this;
var _61675__$1 = this;
return self__.meta61674;
}));

(athens.devcards.spinner.t_athens$devcards$spinner61673.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner61673.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__48665__auto__,devcard_opts__48666__auto__){
var self__ = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner61673.getBasis = (function (){
...
(athens.devcards.spinner.t_athens$devcards$spinner61673.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner61673.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner61673");

(athens.devcards.spinner.t_athens$devcards$spinner61673.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner61673");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner61673.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner61673 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner61673(meta61674){
return (new athens.devcards.spinner.t_athens$devcards$spinner61673(meta61674));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner61673(null));
})()
...
(athens.devcards.spinner.t_athens$devcards$spinner61676.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__48665__auto__,devcard_opts__48666__auto__){
var self__ = this;
var this__48665__auto____$1 = this;
