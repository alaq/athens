...
var G__56424 = (i__4790__auto___56423 + (1));
i__4790__auto___56423 = G__56424;
continue;
} else {
}
break;
...
/** @this {Function} */
(instaparse.combinators_source.alt.cljs$lang$applyTo = (function (seq56364){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq56364));
}));
...
var G__56433 = (i__4790__auto___56431 + (1));
i__4790__auto___56431 = G__56433;
continue;
} else {
}
break;
...
/** @this {Function} */
(instaparse.combinators_source.ord.cljs$lang$applyTo = (function (seq56367){
var G__56368 = cljs.core.first(seq56367);
var seq56367__$1 = cljs.core.next(seq56367);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56368,seq56367__$1);
}));
...
/** @this {Function} */
(instaparse.combinators_source.cat.cljs$lang$applyTo = (function (seq56370){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq56370));
}));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(parser__$1,new cljs.core.Keyword(null,"parser","parser",-1543495310),(function (){var G__56373 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser__$1);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(parser__$1,new cljs.core.Keyword(null,"parser1","parser1",-439601422),(function (){var G__56374 = new cljs.core.Keyword(null,"parser1","parser1",-439601422).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1 ? instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1(G__56374) : instaparse.combinators_source.unhide_content.call(null,G__56374));
})(),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"parser2","parser2",1013754688),(function (){var G__56375 = new cljs.core.Keyword(null,"parser2","parser2",1013754688).cljs$core$IFn$_invoke$arity$1(parser__$1);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$combinators_source$unhide_all_content_$_iter__56376(s__56377){
...
cljs.core.chunk_append(b__56379,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,instaparse.combinators_source.unhide_content(v)], null));

var G__56488 = (i__56378 + (1));
i__56378 = G__56488;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56379),instaparse$combinators_source$unhide_all_content_$_iter__56376(cljs.core.chunk_rest(s__56377__$2)));
} else {
...
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,instaparse.combinators_source.unhide_content(v)], null),instaparse$combinators_source$unhide_all_content_$_iter__56376(cljs.core.rest(s__56377__$2)));
}
} else {
return null;
}
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$combinators_source$unhide_tags_$_iter__56386(s__56387){
return (new cljs.core.LazySeq(null,(function (){
var s__56387__$1 = s__56387;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__56387__$1);
if(temp__5735__auto__){
var s__56387__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__56387__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__56387__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__56389 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__56388 = (0);
while(true){
if((i__56388 < size__4581__auto__)){
var vec__56390 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__56388);
...
cljs.core.chunk_append(b__56389,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null));

var G__56498 = (i__56388 + (1));
i__56388 = G__56498;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56389),instaparse$combinators_source$unhide_tags_$_iter__56386(cljs.core.chunk_rest(s__56387__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56389),null);
}
} else {
var vec__56393 = cljs.core.first(s__56387__$2);
...
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null),instaparse$combinators_source$unhide_tags_$_iter__56386(cljs.core.rest(s__56387__$2)));
}
} else {
return null;
}
...
if(cljs.core.truth_(temp__5733__auto__)){
var reduction = temp__5733__auto__;
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$combinators_source$unhide_all_$_iter__56396(s__56397){
return (new cljs.core.LazySeq(null,(function (){
var s__56397__$1 = s__56397;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__56397__$1);
if(temp__5735__auto__){
var s__56397__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__56397__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__56397__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__56399 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__56398 = (0);
while(true){
if((i__56398 < size__4581__auto__)){
var vec__56400 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__56398);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56400,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56400,(1),null);
cljs.core.chunk_append(b__56399,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(instaparse.combinators_source.unhide_content(v),new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null));

var G__56509 = (i__56398 + (1));
i__56398 = G__56509;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56399),instaparse$combinators_source$unhide_all_$_iter__56396(cljs.core.chunk_rest(s__56397__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56399),null);
}
} else {
var vec__56403 = cljs.core.first(s__56397__$2);
...
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(instaparse.combinators_source.unhide_content(v),new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null),instaparse$combinators_source$unhide_all_$_iter__56396(cljs.core.rest(s__56397__$2)));
}
} else {
return null;
}
...
var G__56407 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
var G__56407__$1 = (((G__56407 instanceof cljs.core.Keyword))?G__56407.fqn:null);
switch (G__56407__$1) {
case "nt":
case "epsilon":
return parser;
...
case "alt":
case "cat":
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(parser,new cljs.core.Keyword(null,"parsers","parsers",-804353827),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__56406_SHARP_){
return (instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2 ? instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2(p1__56406_SHARP_,ws_parser) : instaparse.combinators_source.auto_whitespace_parser.call(null,p1__56406_SHARP_,ws_parser));
}),new cljs.core.Keyword(null,"parsers","parsers",-804353827).cljs$core$IFn$_invoke$arity$1(parser)));

break;
case "ord":
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(parser,new cljs.core.Keyword(null,"parser1","parser1",-439601422),(function (){var G__56408 = new cljs.core.Keyword(null,"parser1","parser1",-439601422).cljs$core$IFn$_invoke$arity$1(parser);
...
})(),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"parser2","parser2",1013754688),(function (){var G__56410 = new cljs.core.Keyword(null,"parser2","parser2",1013754688).cljs$core$IFn$_invoke$arity$1(parser);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56407__$1)].join('')));
...
var modified_grammar = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$combinators_source$auto_whitespace_$_iter__56412(s__56413){
return (new cljs.core.LazySeq(null,(function (){
var s__56413__$1 = s__56413;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__56413__$1);
if(temp__5735__auto__){
var s__56413__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__56413__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__56413__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__56415 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__56414 = (0);
while(true){
if((i__56414 < size__4581__auto__)){
var vec__56416 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__56414);
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56416,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56416,(1),null);
cljs.core.chunk_append(b__56415,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [nt,instaparse.combinators_source.auto_whitespace_parser(parser,ws_parser)], null));

var G__56519 = (i__56414 + (1));
i__56414 = G__56519;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56415),instaparse$combinators_source$auto_whitespace_$_iter__56412(cljs.core.chunk_rest(s__56413__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56415),null);
}
} else {
var vec__56419 = cljs.core.first(s__56413__$2);
...
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [nt,instaparse.combinators_source.auto_whitespace_parser(parser,ws_parser)], null),instaparse$combinators_source$auto_whitespace_$_iter__56412(cljs.core.rest(s__56413__$2)));
}
} else {
return null;
}
