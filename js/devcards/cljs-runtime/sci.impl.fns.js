...
var G__59076 = cljs.core.next(args__$1);
var G__59077 = cljs.core.next(params__$1);
var G__59078 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__59076;
params__$1 = G__59077;
ret = G__59078;
continue;
...
var vec__59045 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59045,(0),null);
var vec__59048 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59045,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59048,(0),null);
...
var map__59057 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59057__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59057__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
G__59092.cljs$lang$applyTo = (function (arglist__59095){
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__59065_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__59065_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__59096__delegate = function (args){
...
while (G__59097__i < G__59097__a.length) {G__59097__a[G__59097__i] = arguments[G__59097__i + 0]; ++G__59097__i;}
  args = new cljs.core.IndexedSeq(G__59097__a,0,null);
} 
return G__59096__delegate.call(this,args);};
G__59096.cljs$lang$maxFixedArity = 0;
G__59096.cljs$lang$applyTo = (function (arglist__59098){
var args = cljs.core.seq(arglist__59098);
return G__59096__delegate(args);
});
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__59066_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__59066_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
