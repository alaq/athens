...
if(cljs.core.truth_((function (){var fexpr__57952 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57952.cljs$core$IFn$_invoke$arity$1 ? fexpr__57952.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57952.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__57953 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__57953.cljs$core$IFn$_invoke$arity$1 ? fexpr__57953.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57953.call(null,type));
})())){
} else {
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57958){
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57961 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57961) : instaparse.reduction.node_builders.call(null,G__57961));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq57955){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57956,G__57957,seq57955__$2);
}));
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57965){
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57971 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57971) : instaparse.reduction.node_builders.call(null,G__57971));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq57962){
var G__57963 = cljs.core.first(seq57962);
var seq57962__$1 = cljs.core.next(seq57962);
var G__57964 = cljs.core.first(seq57962__$1);
var seq57962__$2 = cljs.core.next(seq57962__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57963,G__57964,seq57962__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k57973,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k57973,else__4442__auto__);
...
var vec__57981 = p__57980;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57981,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57981,(1),null);
...
var h__4297__auto____$1 = (function (){var fexpr__57987 = (function (coll__4436__auto__){
return (-360509877 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__57987(this__4435__auto____$1);
})();
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this57974,other57975){
var self__ = this;
var this57974__$1 = this;
return (((!((other57975 == null)))) && ((this57974__$1.constructor === other57975.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57974__$1.grammar,other57975.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57974__$1.start_production,other57975.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57974__$1.output_format,other57975.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57974__$1.__extmap,other57975.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__57972){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__57997 = cljs.core.keyword_identical_QMARK_;
var expr__57998 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__58001 = new cljs.core.Keyword(null,"grammar","grammar",1881328267);
var G__58002 = expr__57998;
return (pred__57997.cljs$core$IFn$_invoke$arity$2 ? pred__57997.cljs$core$IFn$_invoke$arity$2(G__58001,G__58002) : pred__57997.call(null,G__58001,G__58002));
})())){
return (new instaparse.core.Parser(G__57972,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__58004 = new cljs.core.Keyword(null,"start-production","start-production",687546537);
...
return (new instaparse.core.Parser(self__.grammar,G__57972,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__58007 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676);
var G__58008 = expr__57998;
return (pred__57997.cljs$core$IFn$_invoke$arity$2 ? pred__57997.cljs$core$IFn$_invoke$arity$2(G__58007,G__58008) : pred__57997.call(null,G__58007,G__58008));
})())){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__57972,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__57972),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__57972){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__57972,self__.__extmap,self__.__hash));
}));
...
(instaparse.core.Parser.prototype.apply = (function (self__,args57978){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args57978)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__57976){
var extmap__4478__auto__ = (function (){var G__58035 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__57976,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__57976)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__58035);
} else {
return G__58035;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__57976),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__57976),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__57976),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var args__4795__auto__ = [];
var len__4789__auto___58139 = arguments.length;
var i__4790__auto___58140 = (0);
while(true){
if((i__4790__auto___58140 < len__4789__auto___58139)){
args__4795__auto__.push((arguments[i__4790__auto___58140]));

var G__58144 = (i__4790__auto___58140 + (1));
i__4790__auto___58140 = G__58144;
continue;
} else {
}
break;
